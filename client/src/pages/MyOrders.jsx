...
const MyOrders = () => {
  ...
  // Fetch orders when user logs in or when component mounts
  useEffect(() => {
  ...
  // Use userOrders from context, fallback to dummy if empty
  const orders = userOrders && userOrders.length > 0 ? userOrders : dummyOrders;
